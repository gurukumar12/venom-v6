...
bot = telebot.TeleBot('7961808095:AAEVZJRHZK29-knUpcvTmg8TYWBW-HbEWKE')
...
def start_attack_reply(message, target, port, time):
    ...
    response = f"{username}, 𝐀𝐓𝐓𝐀𝐂𝐊 𝐒𝐓𝐀𝐑𝐓𝐄𝐃.🔥🔥\n\n𝐓𝐚𝐫𝐠𝐞𝐭: {target}\n𝐏𝐨𝐫𝐭: {port}\n𝐓𝐢𝐦𝐞: {time} 𝐒𝐞𝐜𝐨𝐧𝐝𝐬\n𝐌𝐞𝐭𝐡𝐨𝐝: VIP- User of @luckysahu111"
    bot.reply_to(message, response)
...
3. MAKE SURE YOU JOINED https://t.me/@luckysahu07 OTHERWISE NOT WORK
